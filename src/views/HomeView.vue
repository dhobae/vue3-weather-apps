<template>
  <main class="container text-white">
    <div class="relative pt-4 mb-8">
      ...
      <ul class="absolute bg-weather-secondary text-white w-full border py-2 px-1 top-[66px]"
        ...
        <template v-else>
          <li v-for="searchResult in mapboxSearchResults" :key="searchResult.id"
            class="px-2 py-2 mx-6 font-semibold border-b cursor-pointer" @click="previewCity(searchResult)">
